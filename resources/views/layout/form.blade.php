...
<body class="bg-gray-100 p-8">
    <div class="max-w-md mx-auto bg-white rounded p-8">
        ...
        <form action={{route('thunder')}} method="POST">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="email" id="telefono" name="email" placeholder="Ingrese el E-mail" class="form-input w-full border-gray-300 border focus:outline-none px-2 py-1 text-[14px] rounded-md">
            </div>
            <div class="mb-4">
                <label for="telefono" class="block text-gray-700 font-bold mb-2">Contraseña</label>
                <input type="password" id="telefono" name="password" placeholder="Ingrese una Constraseña" class="form-input w-[50%] border-gray-300 border focus:outline-none px-2 py-1 text-[14px] rounded-md">
            </div>
